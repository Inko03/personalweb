...
<span className={`${styles.text18} ${styles.texttech}`}>JavaScript</span>
<div className={styles.line19}></div>
<span className={`${styles.text19} ${styles.texttech}`}>SQL</span>
<div className={styles.line20}></div>
<span className={`${styles.text20} ${styles.texttech}`}>NodeJS</span>
</div>
    )
}